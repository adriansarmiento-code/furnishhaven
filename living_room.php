...
$products = [];
$sql = "SELECT id, main_image, name, price, description FROM products WHERE category = 'Living Room'";
...
<head>
    ...
    <title><?php echo $selected_product ? $selected_product['name'] . ' - Product Details' : 'Living Room - Product Listing'; ?> | Furnish Haven</title>
...
<body>
    ...
    <div class="container">
        ...
        <?php else: ?>
            <!-- Hero Section -->
            <div class="hero">
                <img src="img/livingroom.avif" alt="Living Room" class="hero-image">
                <div class="hero-content">
                    <h1>Transform Your Living Space</h1>
                    <p>Discover our premium collection of living room furniture designed for comfort and style</p>
                    <a href="#featured" class="hero-btn">Shop Now</a>
                </div>
            </div>
            
            <h2 id="featured">Featured Living Room Collection</h2>
            <?php if (!$selected_product): ?>
