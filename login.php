...
<script>
    ...
    // Fill admin credentials when admin login link is clicked
    function fillAdminCredentials() {
        document.querySelector('input[name="username"]').value = 'furnishhaven';
        document.querySelector('input[name="password"]').value = 'dwebfinals';
