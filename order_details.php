        ...
        <div class="order-details-section">
            ...
            <?php else: ?>
                ...
                <div class="shipping-info">
                    ...
                    <p>Name: <?php echo htmlspecialchars($order_summary['shipping_name']); ?></p>
                    <p>Address: <br> <?php echo htmlspecialchars($order_summary['shipping_address']); ?></p>
                    <p><?php echo htmlspecialchars($order_summary['shipping_city']); ?>, <?php echo htmlspecialchars($order_summary['shipping_state']); ?> <?php echo htmlspecialchars($order_summary['shipping_postal_code']); ?></p>
                    <p><?php echo htmlspecialchars($order_summary['shipping_country']); ?></p>
                    <?php if (!empty($order_summary['shipping_phone_number'])): ?>
                        <p>Phone: <?php echo htmlspecialchars($order_summary['shipping_phone_number']); ?></p>
                    <?php endif; ?>
                </div>
                </div>
