...
<body>
    ...
    <section class="hero">
        <div class="container">
            ...
            <h2>Discover handcrafted furniture that combines comfort, quality, and timeless style for your dream home</h2>
            <br> 
            <br> 
            <div class="hero-btns">
    ...
    <div class="container">
        <div class="quick-links">
            <a href="#new-arrivals" class="btn">New Arrivals</a>
            <a href="#best-sellers" class="btn">Best Sellers</a>
            <a href="#categories" class="btn">Shop by Categories</a>
        </div>
    </div>
